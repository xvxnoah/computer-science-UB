...
void setup() {
  ...
  //diem a Arduino que consideri el leedPIN com a INPUT
...
void loop() {
  ...
  if(cops_no_descobert == 5){
    Serial.println("El primer jugador ha guanyat");
    exit(0);
  }
  ...
  guanya el joc*/
  if(cops_descobert == 3){
    Serial.println("El segon jugador ha guanyat");
    exit(0);
  }
